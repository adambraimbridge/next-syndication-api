...
describe(MODULE_ID, function() {
	...
	describe('users', function() {
		const { user: userProfile } = require(path.resolve(
			`${FIXTURES_DIRECTORY}/userProfile.json`
		));

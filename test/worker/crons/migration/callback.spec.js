...
//		slackStub.restore();
	...
	before(async function () {
		...
		db.syndication.upsert_contract_asset_item.resolves([contractResponse.items[0]]);
		db.syndication.upsert_contract_asset_register.resolves([contractResponse.items[0]]);
	...
	it('migrates contracts', async function () {
		...
		expect(db.syndication.upsert_contract_asset_register.getCall(0)).to.have.been.calledWith([contractResponse.contract_id, contractResponse.items[0]]);
		...
		expect(db.syndication.upsert_contract_asset_register.getCall(1)).to.have.been.calledWith([contractResponse.contract_id, contractResponse.items[1]]);
	});

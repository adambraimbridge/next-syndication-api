...
describe(MODULE_ID, function() {
	...
	let downloadedItems = [
		...
		},
		{
			...
			content_url:
				'http://www.ft.com/content/ef4c49fe-980e-11e7-b83c-9588e51488a0',
		...
		},
		{
			...
			content_url:
				'http://www.ft.com/video/b16fce7e-3c92-48a3-ace0-d1af3fce71af',
	...
	let savedItems = [
		...
		},
		{
			...
			content_url:
				'http://www.ft.com/video/a1af0574-eafb-41bd-aa4f-59aa2cd084c2',
	...
	beforeEach(function() {
		underTest = proxyquire('../../../server/controllers/resolve', {
			'../lib/get-all-existing-items-for-contract': sinon
				.stub()
				.resolves(allItems),

...
describe(MODULE_ID, function() {
	...
	describe('referrer !== /republishing/save', function() {
		const deletedItem = {
			...
			content_url:
				'http://www.ft.com/content/42ad255a-99f9-11e7-b83c-9588e51488a0',
		...
		before(async function() {
			...
			underTest = proxyquire(
				'../../../server/controllers/unsave-by-content-id',
				{
					'../lib/get-content-by-id': sinon
						.stub()
						.resolves(
							require(path.resolve(
								`${FIXTURES_DIRECTORY}/content/42ad255a-99f9-11e7-b83c-9588e51488a0.json`
							))
						),
				}
			);
			...
			req = httpMocks.createRequest({
				...
				headers: {
					'ft-real-url':
						'https://www.ft.com/syndication/unsave/42ad255a-99f9-11e7-b83c-9588e51488a0',
					'ft-real-path':
						'/syndication/unsave/42ad255a-99f9-11e7-b83c-9588e51488a0',
					'ft-vanity-url':
						'/syndication/unsave/42ad255a-99f9-11e7-b83c-9588e51488a0',
					'ft-flags-next-flags': '',
					'ft-flags': '-',
		...
		it('calls the syndication.delete_save_history_by_contract_id stored procedure', function() {
			expect(
				res.locals.$DB.syndication.delete_save_history_by_contract_id
			).to.have.been.calledWith([
				res.locals.syndication_contract.id,
				deletedItem.content_id,
			]);
		});
	...
	describe('referrer === /republishing/save', function() {
		...
		it('redirects back to the /republishing/save page', function() {
			expect(res.redirect).to.have.been.calledWith(
				'https://www.ft.com/republishing/save'
			);
		});

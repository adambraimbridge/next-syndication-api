...
describe(MODULE_ID, function () {
	...
	it('returns true if all flags being checked are "on"', function() {
		...
		expect(underTest(flags, 'flag1', 'flag3', 'flag5', 'flag7', 'flag9')).to.be.true;
	});

	it('returns false if any of the flags being checked are not "on"', function() {
		expect(underTest(flags, 'flag2')).to.be.false;

		expect(underTest(flags, 'flag2', 'flag3', 'flag5', 'flag7', 'flag8')).to.be.false;

		expect(underTest(flags, 'flag1', 'flag3', 'flag4', 'flag7', 'flag8')).to.be.false;

		expect(underTest(flags, 'flag1', 'flag3', 'flag5', 'flag7', 'flag8')).to.be.false;
	});
});

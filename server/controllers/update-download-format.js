...
const ALLOWED_FORMATS = Object.values(DOWNLOAD_ARTICLE_FORMATS).reduce(
	(acc, val) => {
		acc[val] = val;
...
module.exports = exports = async (req, res, next) => {
	...
	try {
		...
		log.debug(`${MODULE_ID} | Persisted user#${user.user_id} to DB`, {
			user,
		});
		...
		if (
			referrer.endsWith('/republishing/contract') &&
